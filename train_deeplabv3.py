...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(save_file, "save_weights_deep_labv3/model_{}.pth".format(epoch))
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"D:\datasets\MaSTr1325", help="MaSTr1325 root")
...
if __name__ == '__main__':
    ...
    if not os.path.exists("./save_weights_deep_labv3"):
        os.mkdir("./save_weights_deep_labv3")
